...
int main(void) {
    ...
    //const char a_str[] = "1000000000000000000000000000001";
    const char a_str[] = "12341893";
    const char b_str[] = "564689";
    struct ListNode *total_node = NULL;
    l1 = store_num_to_list_node(a_str);
    print_list_node(l1);
    l2 = store_num_to_list_node(b_str);
    print_list_node(l2);
